module RiscV_CPU #(
    ...
    Control_Path name1 (clk, reset, Condition, StallD, FlushD, FlushE, Instr[30], Instr[14:12], Instr[6:0], RegWriteM, RegWriteW, WE, ALUSrcA,
                        ALUSrcBE, UseRs1D, UseRs2D, JALR, PCSrc, ResultSrcE, ResultSrcM, ImmSrc, ALUControl);
    Data_Path name2 (clk, reset, RegWriteM, RegWriteW, ALUSrcA, ALUSrcBE, UseRs1D, UseRs2D, JALR, PCSrc, ResultSrcE, ResultSrcM, ImmSrc, 
